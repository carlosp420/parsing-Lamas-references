...
def fill_authors(input_file):
    ...
    for raw_line in data:
        ...
        elif line.startswith(" ") and authors != "":
...
def main():
    parser = argparse.ArgumentParser(description="Takes a txt version of Lamas' "
                                                 "bibliography of butterflies and "
                                                 "adds authors to each reference. ")
    parser.add_argument('-i', '--input', dest='input_file', action='store',
                        help='filename of txt file containing biblio references.')
